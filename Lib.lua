...
local Utility = {}
local Objects = {}
function Axal:DraggingEnabled(frame, parent)
...
function Axal.CreateLib(kavName, themeList)
    ...
    Axal:DraggingEnabled(MainHeader, Main)
    ...
    function Axal:ChangeColor(prope,color)
